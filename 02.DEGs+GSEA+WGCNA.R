...
diffSig=Diff[with(Diff, (abs(logFC)>0.5 & adj.P.Val < 0.05 )), ]
...
fpkm = read.table(paste0("1.rawexp_",GSE,".txt"),header=T,comment.char = "",check.names=F)#########file name can be changed###
...
#sizeGrWindow(12,12)
pdf(file=paste0(afdir,"/2_Sample dendrogram and trait heatmap.pdf"),width=18,height=11)
